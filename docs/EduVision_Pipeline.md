...
| Person Detection (YOLO) | Phát hiện người (sinh viên, giảng viên) trong khung hình |
| Multi-Obj Tracking (ByteTrack) | Theo dõi và gán ID duy nhất cho từng người |
| Face Detection (SCRFD) | Định vị vùng khuôn mặt của người được theo dõi |
| Face Recognition (InsightFace) | Nhận diện danh tính sinh viên/giảng viên |
| Pose Estimation (YOLO-pose) | Ước lượng tư thế cơ thể để lấy điểm xương |
| Head Gaze (MediaPipe) | Xác định hướng nhìn và độ nghiêng đầu từ khuôn mặt |
| Off-task Obj Det (YOLO) | Phát hiện vật dụng ngoài bài học (điện thoại, máy tính...) |
